...
if(agree==null ||agree!="동의함"){
	out.print("<div class=\"ins_inner\"><p>라이센스(License) 내용에 동의하셔야 설치를 계속하실 수 있습니다.</p>");
	out.print("<div class=\"inner_btn\"><a href=\"./\">뒤로가기</a></div></div>");
//	return;
}
%>

<form id="frm_install" method="post" action="./install_db.jsp"
	autocomplete="off" onsubmit="return frm_install_submit(this)">
		...
		<table class="ins_frm">
			...
			<tbody>
				<tr>
					...
					<td><input name="mysql_host" type="text" value="localhost"
						id="mysql_host"></td>
				</tr>
				<tr>
					<th scope="row"><label for="mysql_user">User</label></th>
					<td><input name="mysql_user" type="text" id="mysql_user">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="mysql_pass">Password</label></th>
					<td><input name="mysql_pass" type="text" id="mysql_pass">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="mysql_db">DB</label></th>
					<td><input name="mysql_db" type="text" id="mysql_db">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="table_prefix">TABLE명 접두사</label></th>
					<td><input name="table_prefix" type="text" value="g5_"
						id="table_prefix"> <span>가능한 변경하지 마십시오.</span></td>
				</tr>
				<tr>
					<th scope="row"><label for="">쇼핑몰TABLE명 접두사</label></th>
					<td><span>가능한 변경하지 마십시오.</span> <input name="g5_shop_prefix"
						type="text" value="g5_shop_" id="g5_shop_prefix"></td>
				</tr>
				<tr>
					<th scope="row"><label for="">
							<%out.print("G5_VERSION 재설치"); %>
					</label></th>
					<td><input name="g5_install" type="checkbox" value="1"
						id="g5_install">재설치</td>
				</tr>
				<tr>
					<th scope="row"><label for="">쇼핑몰설치</label></th>
					<td><input name="g5_shop_install" type="checkbox" value="1"
						id="g5_shop_install" checked="checked">설치</td>
				</tr>
			</tbody>
		</table>
		...
		<table class="ins_frm">
			...
			<tbody>
				<tr>
					...
					<td><input name="admin_id" type="text" value="admin"
						id="admin_id"></td>
				</tr>
				<tr>
					<th scope="row"><label for="admin_pass">비밀번호</label></th>
					<td><input name="admin_pass" type="text" id="admin_pass">
					</td>
				</tr>
				<tr>
					<th scope="row"><label for="admin_name">이름</label></th>
					<td><input name="admin_name" type="text" value="최고관리자"
						id="admin_name"></td>
				</tr>
				<tr>
					<th scope="row"><label for="admin_email">E-mail</label></th>
					<td><input name="admin_email" type="text"
						value="admin@domain.com" id="admin_email"></td>
				</tr>
			</tbody>
		</table>

		<p>
			<strong class="st_strong">주의! 이미<%out.println("가 존재한다면 DB 자료가 망실되므로 주의하십시오."); %>
			</strong><br> 주의사항을 이해했으며, 그누보드 설치를 계속 진행하시려면 다음을 누르십시오.
		</p>
